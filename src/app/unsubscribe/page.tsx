...
function UnsubscribeContent() {
  ...
  return (
    <>
      {status === 'success' ? (
        <>
          <div style={{ fontSize: '48px', margin: '0 auto 16px', textAlign: 'center' }}>✅</div>
          <h1
            style={{
          ...
          <p style={{ color: '#777777', fontSize: '15px', lineHeight: 1.6, marginBottom: '32px', textAlign: 'center' }}>
        ...
        <>
          ...
          <form onSubmit={onSubmit}>
            ...
            {status === 'error' && (
              <p style={{ color: '#FF00FF', fontSize: '13px', marginBottom: '16px', textAlign: 'center' }}>{message}</p>
            )}
          ...
          <p style={{ color: '#444444', fontSize: '12px', marginTop: '24px', textAlign: 'center' }}>
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Suspense fallback={<p style={{ color: '#999', textAlign: 'center' }}>Laden...</p>}>
          <UnsubscribeContent />
        </Suspense>
      </div>
    </main>
